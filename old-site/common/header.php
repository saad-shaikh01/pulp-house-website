...
<head>
 ...
 <link rel="icon" type=image/png sizes="32x32" href="./assets/frontend/images/logo/favicon.webp" />
   ...
   <script>
    ...
    // Function to open the chat only once after 15 seconds
    function triggerChatPopupOnce() {
        LiveChatWidget.call('maximize'); // Opens the chat
    }

    // Set timeout to open the chat once after 15 seconds of page load
    setTimeout(function() {
        triggerChatPopupOnce();
    }, 15000); // Open chat after 15 seconds
    ...
    <script>
        document.addEventListener("DOMContentLoaded", function () {
            ...
            LiveChatWidget.on("ready", function (data) {
                ...
                // setInterval(openChatAfterDelay, 30002);
...
<noscript>
    <a href="https://www.livechat.com/chat-with/19391817/" rel="nofollow">Chat with us</a>, powered by <a href="https://www.livechat.com/?welcome" rel="noopener nofollow" target="_blank">LiveChat</a>
</noscript>
                    ...
                    <div class="col-lg-6">
                        <div class="topbar-right">
                            <a href="https://thepulphousepublishing.com/" aria-label="navigate to home page">
                                <img src=./assets/frontend/images/logo/logo-white-bp.webp class="img-fluid"
            ...
            <div class="container-fluid">
                <a href="/" aria-label="navigate to home page">
                    <img src="./assets/frontend/images/logo/british-books-publishers.webp" class="img-fluid d-none"
                        alt="The Pulp House Publishing" title="The Pulp House Publishing" loading="eager" width=347 height=99 />
                </a>
                ...
                <div class="collapse navbar-collapse justify-content-center" id="navbarNavAltMarkup">
                    <ul class="navbar-nav align-items-center">
                        ...
                        <li class="nav-item">
                            <a class="nav-link" href="/for-author">For Author </a>
                        </li>
