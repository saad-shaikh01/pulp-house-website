...
export const SectionBadge = ({ title }: Props) => {
    return (
        ...
        <div className="px-4 py-1 rounded-full bg-primary/20 cursor-pointer select-none">
            <div className="bg-[linear-gradient(110deg,#ffffff,45%,#a8a8a8,55%,#ffffff)] bg-[length:250%_100%] bg-clip-text animate-background-shine text-transparent font-medium text-sm">
                {title}
            </div>
        </div>
    )
