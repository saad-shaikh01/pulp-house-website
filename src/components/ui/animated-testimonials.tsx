...
export const AnimatedTestimonials = ({
  ...
  return (
    <div className="max-w-sm md:max-w-4xl mx-auto antialiased font-sans px-4 md:px-8 lg:px-12 py-5 lg:py-10">
      <div className="relative grid grid-cols-1 md:grid-cols-2  gap-20">
        ...
        <div className="flex justify-between flex-col pt-2 md:pt-4">
          <motion.div
            key={active}
            initial={{
              y: 20,
          ...
          >
            <h3 className="text-2xl font-bold dark:text-white text-black uppercase">
          ...
          <div className="flex gap-4 pt-12 md:pt-3">
            <button
              onClick={handlePrev}
              className="h-8 w-8 rounded-full  hover:bg-neutral-800 border border-neutral-800 flex items-center justify-center group/button"
            >
